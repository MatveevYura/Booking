		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				// month_picker = $('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button>' +
					...
					'<div style="float: right"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_next"></button></div></div>'),
			...
			month_picker
				...
				.on('touchend mousedown.xdsoft', function () {
					...
					// custom - edit
					if ($this.hasClass(options.next)) {
							// var f2 = _xdsoft_datetime.getCurrentTime();
							var flag1 = 'next';
						} else if ($this.hasClass(options.prev)) {
							// var f2 = _xdsoft_datetime.getCurrentTime();
							var flag2 = 'prev';
					...
					if(flag1 == 'next')
					{
						// $('xdsoft_monthpicker').find('.xdsoft_next').hide();
						// $('.xdsoft_monthpicker').find('.xdsoft_next').hide();
						// $('.xdsoft_monthpicker').find('.xdsoft_prev').show();
					}

					if(flag2 == 'prev')
					{
						// $('.xdsoft_monthpicker').find('.xdsoft_next').show();
						// $('.xdsoft_monthpicker').find('.xdsoft_prev').hide();
					}
						...
						line_time = function line_time(h, m) {
							...
							if ((options.initTime || options.defaultSelect || datetimepicker.data('changed')) && current_time.getHours() === parseInt(h, 10) && ((!isALlowTimesInit && options.step > 59) || current_time.getMinutes() === parseInt(m, 10))) {
								if (options.defaultSelect || datetimepicker.data('changed')) {
									...
									var custom_flag = jQuery('#custom_time_flag').val();
									if(custom_flag == 'time_triggered')
									{
										classes.push('xdsoft_current');
									}
